...
urlpatterns = [
    ...
    path('staff/inventory/credit-payment/', views.inventory_record_credit_payment, name='inventory_record_credit_payment'),
    path('staff/inventory/parties/', views.inventory_party_dashboard, name='inventory_party_dashboard'),
    path('staff/inventory/parties/<int:party_id>/ledger/', views.inventory_party_ledger, name='inventory_party_ledger'),
    ...
    path('api/mobile/inventory/summary/', views.mobile_api_inventory_summary, name='mobile_api_inventory_summary'),
    path('api/mobile/inventory/parties/', views.mobile_api_inventory_parties, name='mobile_api_inventory_parties'),
    path('api/mobile/inventory/parties/<int:party_id>/update/', views.mobile_api_inventory_party_update, name='mobile_api_inventory_party_update'),
    path('api/mobile/inventory/register/<str:entry_type>/', views.mobile_api_inventory_register, name='mobile_api_inventory_register'),
    ...
    # --- New reports ---
    path('staff/reports/service-jobs/', views.service_job_report, name='service_job_report'),
    path('staff/reports/service-jobs/export/csv/', views.service_job_report_export_csv, name='service_job_report_export_csv'),
    path('staff/reports/job-status-history/', views.job_status_history_report, name='job_status_history_report'),
    path('staff/reports/job-status-history/export/csv/', views.job_status_history_report_export_csv, name='job_status_history_report_export_csv'),
    path('staff/reports/job-parts/', views.job_parts_report, name='job_parts_report'),
    path('staff/reports/job-parts/export/csv/', views.job_parts_report_export_csv, name='job_parts_report_export_csv'),
    path('staff/reports/technician-master/', views.technician_master_report, name='technician_master_report'),
    path('staff/reports/technician-master/export/csv/', views.technician_master_report_export_csv, name='technician_master_report_export_csv'),
